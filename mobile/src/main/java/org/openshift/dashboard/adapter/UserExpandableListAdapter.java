...
public class UserExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public UserExpandableListAdapter(Context context, List<ExpandedMenuModel> listDataHeader, HashMap<ExpandedMenuModel, List<String>> listChildData, ExpandableListView mView) {
